...
function playMusic() {
  ...
  const second = 1000,
    ...
    hour = minute * 60,
    day = hour * 24;
  let countDown = new Date('Feb 9, 2025 00:00:00').getTime(),
  ...
  new TypeIt("#text1", {
    strings: ["Сайн уу? Аягуу мундаг найз залуу нь байна өө", "Аягуу лаг код бичдэг гээд байсан юу хийдийн бол гэж миний хайр бодож байсан уу?", "Тэгсэн хайр нь нэг ийм л юм хийгээд байдаг юмшд хэхэ", "Хайрдаа хамгийн эхлээд төрсөн өдрийн мэнд хүргэе!!!" , "Хорвоод мэндэлсэн чинь наддаа хамгийн том бэлэг болсон юм шүү."],
    startDelay: 4000,
    speed: 75,
  ...
  new TypeIt("#text2", {
    strings: ["Чи бид хоёрын аялал дөнгөж эхэлж байгаа ч надад байнга хамт байх ёстой юм шиг угаасаа л хамт заяагдсан юм шиг санагддаг аа.", "Хайр нь чамдаа зөндөө их хайртай чамгүйгээр би одоо болтол нэг тийм зорилгогүй л явж байх байсан байх", "Хайр нь чамайг миний амьдрал орж ирсэнд аягуу их баярладаг шүү", "Зөндөө хайртай, зөндөө үнсэе <3 <3", "-Найз залуу Манлайгаас нь"],
    startDelay: 2000,
    speed: 75,
    waitUntilVisible: true
  }).go();
